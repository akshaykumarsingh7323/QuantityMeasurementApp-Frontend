...
// All API calls must go through API Gateway (e.g., http://localhost:8080)
...
export class AuthService {
  ...
  loginWithGoogle(): void {
    window.location.href = `${environment.apiUrl}/oauth2/authorize/google?redirect_uri=${encodeURIComponent('http://localhost:4200/login')}`;
  }
